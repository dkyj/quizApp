...
### 앱 설명
#### 넌센스 퀴즈 15개 중 랜덤으로 5개가 나옵니다.
#### 4지선다형이며 4개중 정답을 고르면 됩니다.
#### 정답을 골랐을 경우 다이얼로그 창으로 '정답입니다', 오답을 골랐을 경우 '틀렸습니다' 하고 정답을 알려줍니다.
#### 5개의 문제를 다 풀면 자신의 점수가 나오게 됩니다.

### 주요코드
#### 15개의 퀴즈 배열을 생성하여 그 중 퀴즈 5개를 랜덤으로 나오도록 했습니다.
#### 배열 2번째에 들어가 있는 것을 정답으로 설정하고 정답 순서도 랜덤으로 설정했습니다.
```
...
#### 퀴즈 정답을 하나 고를 때마다 정답이 맞는지 아닌지를 확인하기 위해 다이얼로그 창을 추가했습니다.
#### 정답이 맞다면 정답입니다, 틀렸다면 틀렸습니다 하고 정답을 보여줍니다.
